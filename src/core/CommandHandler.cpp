...
//     } else if (cmd == "CETAK_PROPERTI" || cmd == "PROPERTI" || cmd ==
//     "PROPERTY") {
//         handleCetakProperti();
...
//     } else if (cmd == "GUNAKAN_KEMAMPUAN" || cmd == "SKILL" || cmd ==
//     "KARTU") {
...
//         std::cout << "Dadu diatur: " << d1 << " + " << d2 << " = " << (d1 +
//         d2) << std::endl; game->rollDice();
...
//             std::cout << selected->getName() << " berhasil digadaikan!" <<
//             std::endl; std::cout << "Anda menerima M" <<
//             selected->getMortgageValue() << std::endl;
//         } catch (const std::exception& e) {
//             std::cout << "Error: " << e.what() << std::endl;
//         }
//     }
...
//             std::cout << selected->getName() << " berhasil ditebus!" <<
//             std::endl;
//         } catch (const std::exception& e) {
//             std::cout << "Error: " << e.what() << std::endl;
//         }
...
//     std::cout << "  ATUR_DADU x y     - Atur dadu manual (cheat)" <<
//     std::endl; std::cout << "  CETAK_PAPAN       - Tampilkan papan permainan"
//     << std::endl; std::cout << std::endl; std::cout << "PROPERTI:" <<
//     std::endl; std::cout << "  CETAK_AKTA kode   - Lihat detail properti" <<
//     std::endl; std::cout << "  CETAK_PROPERTI    - Lihat properti milik Anda"
//     << std::endl; std::cout << "  GADAI             - Gadai properti ke bank"
//     << std::endl; std::cout << "  TEBUS             - Tebus properti yang
//     digadaikan" << std::endl; std::cout << "  BANGUN            - Bangun
//     rumah/hotel" << std::endl; std::cout << std::endl; std::cout << "KARTU:"
//     << std::endl; std::cout << "  GUNAKAN_KEMAMPUAN - Gunakan kartu
//     kemampuan" << std::endl; std::cout << std::endl; std::cout << "SISTEM:"
//     << std::endl; std::cout << "  SIMPAN file       - Simpan permainan" <<
//     std::endl; std::cout << "  MUAT file         - Muat permainan" <<
//     std::endl; std::cout << "  CETAK_LOG [n]     - Tampilkan log transaksi"
//     << std::endl; std::cout << "  HELP              - Tampilkan bantuan ini"
//     << std::endl; std::cout << "  EXIT              - Keluar dari permainan"
//     << std::endl; std::cout << "=====================================" <<
//     std::endl;
// }
